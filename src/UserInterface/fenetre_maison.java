...
public class fenetre_maison extends Stage {
    private Gestion agence;
    public fenetre_maison() {
        this.setTitle("Insertion d'une maison");
        FXMLLoader loader = new FXMLLoader();
        loader.setLocation(getClass().getResource("insert_maison.fxml"));
        Parent root;
        try {
            root = loader.load();
...
// Dans cet exemple on créer une nouvelle fenêtre:
            this.setScene(scene);
            insertion_maison controller =loader.getController();
